 ...
 */
@property (nonatomic) UIPanGestureRecognizer *ycy_panGesture;
 ...
 */
@property (nonatomic) CGRect ycy_cagingArea;
 ...
 */
@property (nonatomic) CGRect ycy_handle;

/**
 Restricts the movement along the X axis
 */
@property (nonatomic) BOOL ycy_shouldMoveAlongX;

/**
 Restricts the movement along the Y axis
 */
@property (nonatomic) BOOL ycy_shouldMoveAlongY;

/**
 Notifies when dragging started
 */
@property (nonatomic, copy) void (^ycy_draggingStartedBlock)();

/**
 Notifies when dragging ended
 */
@property (nonatomic, copy) void (^ycy_draggingEndedBlock)();

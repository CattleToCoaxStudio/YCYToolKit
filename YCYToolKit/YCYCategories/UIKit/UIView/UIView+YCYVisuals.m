...
// Degree -> Rad
#define ycy_degToRad(x) (M_PI * (x) / 180.0)

@implementation UIView (YCYVisuals)

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////

-(void)ycy_cornerRadius: (CGFloat)radius strokeSize: (CGFloat)size color: (UIColor *)color
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)ycy_setRoundedCorners:(UIRectCorner)corners radius:(CGFloat)radius {
...
-(void)ycy_addSubview: (UIView *)subview withTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
	[UIView beginAnimations: nil context: NULL];
	[UIView setAnimationDuration: duration];
      ...
      timingFunction: (CAMediaTimingFunction *)timingFunction
{
    ...
    rotation.toValue = [NSNumber numberWithFloat: ycy_degToRad(angle)];

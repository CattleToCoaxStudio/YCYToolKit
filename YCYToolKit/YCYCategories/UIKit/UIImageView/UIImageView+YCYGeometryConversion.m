...
#import "UIImageView+YCYGeometryConversion.h"

@implementation UIImageView (YCYGeometryConversion)

- (CGPoint)ycy_convertPointFromImage:(CGPoint)imagePoint {
...
- (CGRect)ycy_convertRectFromImage:(CGRect)imageRect {
    CGPoint imageTopLeft     = imageRect.origin;
    CGPoint imageBottomRight = CGPointMake(CGRectGetMaxX(imageRect),
                                          CGRectGetMaxY(imageRect));
    
    CGPoint viewTopLeft     = [self ycy_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self ycy_convertPointFromImage:imageBottomRight];
...
- (CGPoint)ycy_convertPointFromView:(CGPoint)viewPoint {
...
- (CGRect)ycy_convertRectFromView:(CGRect)viewRect {
    CGPoint viewTopLeft = viewRect.origin;
    CGPoint viewBottomRight = CGPointMake(CGRectGetMaxX(viewRect), 
                                          CGRectGetMaxY(viewRect));
    
    CGPoint imageTopLeft = [self ycy_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self ycy_convertPointFromView:viewBottomRight];

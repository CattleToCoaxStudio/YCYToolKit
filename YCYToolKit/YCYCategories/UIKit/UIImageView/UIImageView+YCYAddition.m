...
#import "UIImageView+YCYAddition.h"

@implementation UIImageView (YCYAddition)
...
+ (id)ycy_imageViewWithImageArray:(NSArray *)imageArray duration:(NSTimeInterval)duration;
{
    ...
    UIImageView *imageView = [UIImageView ycy_imageViewWithImageNamed:[imageArray objectAtIndex:0]];

...
#import "UINavigationController+YCYStackManager.h"

@implementation UINavigationController (YCYStackManager)
/**
...
{
    return [self popToViewController:[self ycy_findViewController:className] animated:YES];
}
/**
 *  @brief  pop n层
 *

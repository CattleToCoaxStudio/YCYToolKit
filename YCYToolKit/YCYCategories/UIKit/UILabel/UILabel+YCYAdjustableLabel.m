...
#import "UILabel+YCYAdjustableLabel.h"

@implementation UILabel (JYCYAdjustableLabel)
...
//    
    ...
    CGSize tempSize = [self.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
  ...
  do {
    ...
    [self.text boundingRectWithSize:unconstrainedSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
...
- (void)ycy_adjustLabelToMaximumSize:(CGSize)maxSize
                 minimumFontSize:(int)minFontSize
{
  [self ycy_adjustLabelToMaximumSize:maxSize
...
{
  [self ycy_adjustLabelToMaximumSize:CGSizeZero
                     minimumSize:CGSizeZero 
                 minimumFontSize:minFontSize];
}

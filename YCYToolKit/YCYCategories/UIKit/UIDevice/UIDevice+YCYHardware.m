...
@implementation UIDevice (YCYHardware)
...
+ (NSString *)ycy_platformString{
    NSString *platform = [self ycy_platform];
...
+ (NSUInteger)ycy_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)ycy_cpuFrequency {
    return [self ycy_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)ycy_busFrequency {
    return [self ycy_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)ycy_ramSize {
    return [self ycy_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)ycy_cpuNumber {
    return [self ycy_getSysInfo:HW_NCPU];
}


+ (NSUInteger)ycy_totalMemoryBytes
{
    return [self ycy_getSysInfo:HW_PHYSMEM];
}

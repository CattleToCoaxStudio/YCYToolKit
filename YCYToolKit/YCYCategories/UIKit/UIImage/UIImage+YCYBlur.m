...
#import "UIImage+YCYBlur.h"
#import <Accelerate/Accelerate.h>
@implementation UIImage (YCYBlur)
#pragma mark -
#pragma mark - Effects
...
- (UIImage *)ycy_lightImage
{
    ...
    return [self ycy_blurredImageWithSize:CGSizeMake(60, 60) tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)ycy_extraLightImage
{
    ...
    return [self ycy_blurredImageWithSize:CGSizeMake(40, 40) tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)ycy_tintedImageWithColor:(UIColor *)tintColor
{
    ...
    return [self ycy_blurredImageWithSize:CGSizeMake(20, 20) tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
...
{
    return [self ycy_blurredImageWithSize:CGSizeMake(blurRadius, blurRadius)];
}
...
{
    return [self ycy_blurredImageWithSize:blurSize tintColor:nil saturationDeltaFactor:1.0 maskImage:nil];
}
...
//| ----------------------------------------------------------------------------
- (UIImage *)ycy_blurredImageWithSize:(CGSize)blurSize tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage
{
...
#define ENABLE_TINT                     1
    ...
    if (hasBlur || hasSaturationChange)
    {
        ...
        if (hasBlur)
        {
            CGFloat radiusX = [self ycy_gaussianBlurRadiusWithBlurRadius:blurSize.width * inputImageScale];
            CGFloat radiusY = [self ycy_gaussianBlurRadiusWithBlurRadius:blurSize.height * inputImageScale];
        ...
        if ( (effectCGImage = vImageCreateCGImageFromBuffer(inputBuffer, &format, &ycy_cleanupBuffer, NULL, kvImageNoAllocate, NULL)) == NULL ) {
...
//
- (CGFloat)ycy_gaussianBlurRadiusWithBlurRadius:(CGFloat)blurRadius
{
...
//
void ycy_cleanupBuffer(void *userData, void *buf_data)
{ free(buf_data); }

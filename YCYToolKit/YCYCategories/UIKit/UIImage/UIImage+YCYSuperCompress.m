//
//  UIImage+YCYSuperCompress.m
//
//  Created by Jakey on 16/1/22.
//  Copyright © 2016年 Jakey. All rights reserved.
//

#import "UIImage+YCYSuperCompress.h"

@implementation UIImage (YCYSuperCompress)
...
+ (NSData *)ycy_compressImage:(UIImage *)image toMaxLength:(NSInteger)maxLength maxWidth:(NSInteger)maxWidth{
    ...
    CGSize newSize = [self ycy_scaleImage:image withLength:maxWidth];
    UIImage *newImage = [self ycy_resizeImage:image withNewSize:newSize];

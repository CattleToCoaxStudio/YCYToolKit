...
*/
@interface UIImage (YCYAnimatedGIF)
//返回动态图  根据传入的url 或者data
/*
        UIImage *animation = [UIImage ycy_animatedImageWithAnimatedGIFData:theData];
...
*/
+ (UIImage *)ycy_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
        UIImage *image = [UIImageycy_ animatedImageWithAnimatedGIFURL:theURL];
...
*/
+ (UIImage *)ycy_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;

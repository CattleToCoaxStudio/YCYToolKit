...
#import "NSString+YCYScore.h"

@implementation NSString (YCYScore)

- (CGFloat)ycy_scoreAgainst:(NSString *)otherString{
    return [self ycy_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)ycy_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self ycy_scoreAgainst:otherString fuzziness:fuzziness options:NSStringYCYScoreOptionNone];
}

- (CGFloat)ycy_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringYCYScoreOption)options{
    ...
    if(NSStringYCYScoreOptionFavorSmallerWords == (options & NSStringYCYScoreOptionFavorSmallerWords)){
    ...
    if(NSStringYCYScoreOptionReducedLongStringPenalty == (options & NSStringYCYScoreOptionReducedLongStringPenalty)){

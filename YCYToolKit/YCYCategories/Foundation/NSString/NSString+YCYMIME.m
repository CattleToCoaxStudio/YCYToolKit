...
#import "NSString+YCYMIME.h"

@implementation NSString (YCYMIME)
/**
...
- (NSString *)ycy_MIMEType {
    return [[self class] ycy_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)ycy_MIMETypeForExtension:(NSString *)extension {
    return [[self ycy_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *

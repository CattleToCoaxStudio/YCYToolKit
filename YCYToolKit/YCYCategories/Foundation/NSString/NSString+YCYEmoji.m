...
#import "NSString+YCYEmoji.h"

@implementation NSString (YCYEmoji)

static NSDictionary * ycy_s_unicodeToCheatCodes = nil;
static NSDictionary * ycy_s_cheatCodesToUnicode = nil;

+ (void)ycy_initializeEmojiCheatCodes
{
    ...
    @synchronized(self) {
        ycy_s_unicodeToCheatCodes = forwardMap;
        ycy_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)ycy_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!ycy_s_cheatCodesToUnicode) {
        [NSString ycy_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [ycy_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)ycy_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    if (self.length) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [ycy_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {

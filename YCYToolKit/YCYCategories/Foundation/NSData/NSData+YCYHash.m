...
#import "NSData+YCYHash.h"
#include <CommonCrypto/CommonCrypto.h>
@implementation NSData (ycyHash)
/**
 *  @brief  md5 NSData
 */
- (NSData *)ycy_md5Data
 ...
 *  @return 结果
 */
- (NSData *)ycy_hmacMD5DataWithKey:(NSData *)key {
    return [self ycy_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}
/**
 *  @brief  sha1Data NSData
 *
 ...
 *  @return 结果
 */
- (NSData *)ycy_hmacSHA1DataWithKey:(NSData *)key
{
    return [self ycy_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}
/**
 *  @brief  sha256Data NSData
 *
 ...
 *  @return 结果
 */
- (NSData *)ycy_hmacSHA256DataWithKey:(NSData *)key
{
    return [self ycy_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
/**
 *  @brief  sha512Data NSData
 *
 ...
 *  @return 结果
 */
- (NSData *)ycy_hmacSHA512DataWithKey:(NSData *)key
{
    return [self ycy_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}


- (NSData *)ycy_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
